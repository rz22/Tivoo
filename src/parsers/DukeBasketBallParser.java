...
public class DukeBasketBallParser extends TivooParser {
	...
	protected void setUpHandlers(SAXReader reader) {
		...
		reader.addHandler("/dataroot/Calendar/Subject",
				new GetStringValueHandler());
		reader.addHandler("/dataroot/Calendar/Description",
				new GetStringValueHandler());
		reader.addHandler("/dataroot/Calendar/Location",
				new GetStringValueHandler());
