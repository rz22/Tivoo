...
public class TivooEvent {
	...
	public boolean hasKeyWordSpecial(String keyword, TivooEventType eventtype,
			String attr) {
		if (!getType().equals(eventtype))
			return true;
		String lower = keyword.toLowerCase();
		if (mySpecialAttributes.get(attr).toString().toLowerCase()
				.contains(lower))
			return true;
		return false;
	}
	...
	public int hashCode() {
		return myType.hashCode() * 10000 + myTitle.hashCode() * 100
	...
	public boolean equals(Object o) {
		...
		return (myType.equals(other.getType())
				...
				&& myStart.equals(other.getStart()) && myEnd.equals(other
				.getEnd()));
	}
	...
	public static final Comparator<TivooEvent> EventTimeComparator = new Comparator<TivooEvent>() {
		public int compare(TivooEvent e1, TivooEvent e2) {
			...
			if (startcomp != 0)
				return startcomp;
			Integer duration1 = Seconds.secondsBetween(e1.getStart(),
					e1.getEnd()).getSeconds();
			Integer duration2 = Seconds.secondsBetween(e2.getStart(),
					e2.getEnd()).getSeconds();
